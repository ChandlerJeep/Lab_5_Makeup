...
function loadPlayersPage() {
	...
	for(var i = 0; i < players.length; i ++) {
		tag += "<a href=\"#\" onclick=switchPlayers(" + i + ")>" + players[i].name + "</a><br>";
	}
	document.getElementById("player_selector").innerHTML = tag;
}

function switchPlayers(playerNum) {
	var gamesPlayed = players[playerNum].games_played;
	...
	document.getElementById("g_played").innerHTML = gamesPlayed;
	...
	var averagePassing = Math.round(players[playerNum].pass_yards / gamesPlayed);
	var averageRushing = Math.round(players[playerNum].rushing_yards / gamesPlayed);
	var averageReceiving = Math.round(players[playerNum].receiving_yards / gamesPlayed);
